...
namespace MLNETWebApplicationML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\DAMILOLA\source\repos\MLNETWebApplication\MLNETWebApplication\documents\taxi-fare-train.csv.txt";
        private static string MODEL_FILEPATH = @"../../../../MLNETWebApplicationML.Model/MLModel.zip";
